    ...
    app.register.controller('tradesController', ['$scope', '$rootScope', 'tradesService', 'alertsService', 'dataGridService',
        function ($scope, $rootScope, tradesService, alertsService, dataGridService) {
            ...
            $scope.initializeController = function () {
                ...
                dataGridService.addHeader("Price", "TRADINGPRICE");
                dataGridService.addHeader("Quantity", "TRADINGQTY");
                dataGridService.addHeader("Order Status", "ORDERSTATUS");
                dataGridService.addHeader("Order Result", "ORDERRESULT");
